"""Tests for OnTrac diagnostics."""
from datetime import timedelta
from unittest.mock import MagicMock

from custom_components.ontrac.diagnostics import (
...
async def test_diagnostics_redacts_and_counts(hass):
    ...
    entry = MagicMock()
    entry.options = {"parcels": [{"tracking_code": "1LSCY9R00000000"}]}
    ...
    entry.runtime_data.coordinator.data = [
        {
            "barcode": "1LSCY9R00000000",
            "sender": "MOONACHIE, NJ",
            "receiver": "ORLANDO, FL",
            "status": "out_for_delivery",
            "raw": {
                "Tracking": "1LSCY9R00000000",
                "Consignee": {"City": "ORLANDO", "State": "FL", "PostalCode": "32801"},
    ...
    assert result["incoming"][0]["raw"]["Tracking"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["Consignee"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["VpodImageUrl"] == "**REDACTED**"
