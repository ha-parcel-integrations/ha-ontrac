"""pytest configuration for the OnTrac test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.ontrac`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.ontrac import api
    from custom_components.ontrac import parcels

    api._warned_multi_package = False
