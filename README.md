...
[![Downloads](https://img.shields.io/github/downloads/ha-parcel-integrations/ha-ontrac/total.svg)](https://github.com/ha-parcel-integrations/ha-ontrac/releases)
...
- **Hot (every 15 minutes)** — while any tracked parcel is out for delivery
  ...
  OnTrac, whose tracking endpoint never reports a delivery window at all).
...
- A small, fixed per-hub offset is added on top, so not every OnTrac hub out
...
This is an independent, community-built project. It is not affiliated with, endorsed by, sponsored by, or supported by OnTrac, Home Assistant, or any other third party referenced in this project. Please don't contact OnTrac for support with this integration.
